-- =============================================
-- Online Quiz Portal - Deployment Schema
-- For Aiven MySQL (uses existing database)
-- =============================================
...
CREATE TABLE quizzes (
    ...
    min_percentage_required INT DEFAULT 0,
    max_percentage_required INT DEFAULT 100,
    created_by INT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NULL,
    FOREIGN KEY (course_id) REFERENCES courses(id) ON DELETE CASCADE,
